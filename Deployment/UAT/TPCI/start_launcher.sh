...
launcheradmin.sh -eddir /opt/ibm/wsdtx/systems -asf 012_HIX_GTM_Status.msl -pd "ini:/opt/ibm/wsdtx/config/dtx.ini;rm:local;mrc:/opt/ibm/wsdtx/config/HIX_Registry.mrc" -pf "name:012_HIX_GTM_Status.msl;desc:012_HIX_GTM_Status;ini:/opt/ibm/wsdtx/config/dtx.ini;rm:local;mrc:/opt/ibm/wsdtx/config/HIX_Registry.mrc;as:yes"
launcheradmin.sh -eddir /opt/ibm/wsdtx/systems -asf 013_HIX_GTM_Exception.msl -pd "ini:/opt/ibm/wsdtx/config/dtx.ini;rm:local;mrc:/opt/ibm/wsdtx/config/HIX_Registry.mrc" -pf "name:013_HIX_GTM_Exception.msl;desc:013_HIX_GTM_Exception.msl;ini:/opt/ibm/wsdtx/config/dtx.ini;rm:local;mrc:/opt/ibm/wsdtx/config/HIX_Registry.mrc;as:no"
