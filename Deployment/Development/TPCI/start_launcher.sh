...
launcheradmin.sh -adduser 'user:admin;login:admin;pwd:admin;access:gss,gpr,gm'
launcheradmin.sh -auto -addir /opt/ibm/wsdtx/systems
launcheradmin.sh -eddir /opt/ibm/wsdtx/systems -asf 011_HIX_DateTimeUtil.msl -pd "ini:/opt/ibm/wsdtx/config/dtx.ini;rm:local;mrc:/opt/ibm/wsdtx/config/HIX_Registry.mrc" -pf "name:011_HIX_DateTimeUtil.msl;desc:011_HIX_DateTimeUtil;ini:/opt/ibm/wsdtx/config/dtx.ini;rm:local;mrc:/opt/ibm/wsdtx/config/HIX_Registry.mrc;as:yes"
launcheradmin.sh -eddir /opt/ibm/wsdtx/systems -asf 04X_HIX_MQ_Utilities.msl -pd "ini:/opt/ibm/wsdtx/config/dtx.ini;rm:local;mrc:/opt/ibm/wsdtx/config/HIX_Registry.mrc" -pf "name:04X_HIX_MQ_Utilities.msl;desc:04X_HIX_MQ_Utilities;ini:/opt/ibm/wsdtx/config/dtx.ini;rm:local;mrc:/opt/ibm/wsdtx/config/HIX_Registry.mrc;as:yes"
