      ...
      ******************************************************************        
       01 BCP-RESP-RECORD.                                                      
         ...
         05 BCP-RESP-INFO.                                                      
            ...
            10 BCP-RESP-BANK-ABA-NBR         PIC X(09).                         
            10 BCP-RESP-CHK-SAV-IND          PIC X(02).                         
            10 BCP-RESP-BANK-ACCT-NBR        PIC X(17).                         
            10 BCP-RESP-ACH-DT               PIC X(08).                         
            10 BCP-RESP-ACH-TRACE-NO         PIC X(10).                         
            10 BCP-RESP-PROV-NAME            PIC X(35).                         
            10 BCP-RESP-PROV-NPI             PIC X(10).                         
            10 BCP-RESP-CLM-NO               PIC X(06).                         
            10 BCP-RESP-PAT-NAME-LAST        PIC X(20).                         
            10 BCP-RESP-PAT-NAME-FIRST       PIC X(20).                         
            10 BCP-RESP-POLICY-NO            PIC X(15).                         
            10 BCP-RESP-PAT-TRAN-ID          PIC X(06).                         
            10 BCP-RESP-ERR-CODE             PIC X(03).                         
            10 BCP-RESP-ERR-DESC             PIC X(60).                         
            10 BCP-RESP-FILLERS              PIC X(111).                        
